<?php 
/* Template Name: - Our Top 10 Writers */
...
<div class="container-wrap search-container" data-midnight="dark" style="margin-top: 0px; padding-top: 30px;">
  <div class="container main-content search-content">
    ...
    <div class="row">
      <div class="post-searchby searchbywritersname top10writers col span_12">
        <!--  -->
        <?php
        ...
        if ( $postslist->have_posts() ) :
          while ( $postslist->have_posts() ) : 
            ...
            $writer_name = get_field( 'field_couchwritername' );
            ?>
            <div class="col span_6 ">
              <i class="top10writers"><?php echo get_post($postid)->menu_order; ?></i>
              <div class="image">
              ...
              <div class="desc">
                ...
                <span><?php echo $writerauthorName; ?></span>
...
?>
<style type="text/css">
.post-searchby .col.span_3:nth-of-type(4n) {margin-right: 0; }
i.top10writers {position: absolute;right: 6px;bottom: 1px;font-size: 40px;line-height: 1;opacity: 0.5;color: #ffffff;text-shadow: 1px 3px 1px #ca9b35;transition: all 0.3s linear;}
.post-searchby.searchbywritersname > div.col:hover i.top10writers {opacity: 1; }
